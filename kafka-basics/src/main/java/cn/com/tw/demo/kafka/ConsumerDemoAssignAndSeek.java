...
public class ConsumerDemoAssignAndSeek {
    ...
    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoAssignAndSeek.class);
    ...
    public static void main(String[] args) {
        log.info("==========ConsumerDemoAssignAndSeek==========");
        ...
        // try {
        // assign and seek are mostly used to replay data ro fetch a specific message

        // assign
        final var partitionToReadFrom = new TopicPartition(HELLO_TOPIC, 0);
        ...
        log.info("==========Exiting ConsumerDemoAssignAndSeek==========");
    }
}
