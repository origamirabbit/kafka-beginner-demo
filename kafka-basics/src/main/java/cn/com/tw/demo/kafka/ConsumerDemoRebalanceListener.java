...
import cn.com.tw.demo.kafka.ConsumerImpl.ConsumerRebalanceListenerImpl;
...
public class ConsumerDemoRebalanceListener {
    ...
    public static void main(String[] args) {
        log.info("==========ConsumerDemoRebalancedListener==========");
        ...
        final var listener = new ConsumerRebalanceListenerImpl(consumer);
        ...
        try {
            ...
            consumer.subscribe(List.of(HELLO_TOPIC), listener);
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    // Track the offsets that have been committed in the listener
                    listener.addOffsetToTrack(record.topic(), record.partition(), record.offset());
                }

                // consumer.commitAsync as all data have been processed and prevent blocking until the next .poll() call
